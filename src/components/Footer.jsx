    ...
    <footer className="footer">
        ...
        <div className="container footer-container">
          <div className="footer-content">
            <div className="footer-section">
              <img src={logoImage} alt="Desvarese A Domicilio Bogotá" className="footer-logo" />
              <p>Ofrecemos servicios de asistencia vehicular a domicilio en Bogotá y sus alrededores, con 5 años de experiencia en el mercado.</p>
            ...
            <div className="footer-section">
              ...
              <div className="schedule-item">
                ...
                <span className="hours">24 Horas</span>
              </div>
              <div className="schedule-item">
              ...
              <div className="schedule-item">
                <span className="day">Domingos y Festivos:</span>
                <span className="hours">24 Horas</span>
              </div>
      ...
      <div className="footer-bottom">
        <div className="container">
          <p>&copy; {year} Desvarese A Domicilio Bogotá. Todos los derechos reservados.</p>
          <div className="whatsapp-button">
            <a href="https://wa.me/573215139301" target="_blank" rel="noopener noreferrer">
